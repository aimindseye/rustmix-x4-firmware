...
install -m 0755 "$SCRIPT_DIR/files/scripts/validate_indic_epub_generator_output_repair.sh" \
  "$ROOT/scripts/validate_indic_epub_generator_output_repair.sh"
...
echo "indic-epub-generator-output-repair=applied"
echo "repo=$ROOT"
