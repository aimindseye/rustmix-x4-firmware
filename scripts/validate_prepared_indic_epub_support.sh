...
rg -q 'page_local_file_name' \
  target-xteink-x4/src/rustmix_x4/x4_apps/apps/reader/prepared_txt.rs \
  tools/prepared_txt_real_vfnt/src/main.rs
rg -q 'struct PageBudget' tools/prepared_txt_real_vfnt/src/main.rs
rg -q 'single shaped cluster at byte' tools/prepared_txt_real_vfnt/src/main.rs
rg -q 'resource_split_pages' tools/prepared_txt_real_vfnt/src/main.rs

./scripts/validate_indic_epub_generator_output_repair.sh
./scripts/validate_indic_epub_macos_metadata_repair.sh
