...
use crate::rustmix_x4::x4_apps::fonts::bitmap::FIRST_CHAR;
...
impl ReaderApp {
    ...
    pub(super) fn jump_forward(&mut self) -> bool {
        ...
        if self.prepared_txt.is_active() {
            let last = self.pg.total_pages.saturating_sub(1);
...
// UTF-8 decoding is provided by crate::rustmix_x4::x4_kernel::util::decode_utf8_char
